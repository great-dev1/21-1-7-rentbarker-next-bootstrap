              ...
              <div className={page === 1 ? styles.lead_section : styles.lead_section_mobile_hidden}>
                <div className={styles.lead_header}>
                  ...
                  <div className={styles.status_btns}>
                    <a href="/landlord/lead" className={styles.status_btn}>ALL</a>
                    <a href="#" className={styles.status_btn}>ACTIVE</a>
                    <a href="/landord/lead/pending" className={styles.status_btn_active}>PENDING</a>
                    <a href="#" className={styles.status_btn}>APPROVED</a>
                    <a href="#" className={styles.status_btn}>DECLINE</a>
                  </div>

                  <div className={styles.substatus_btns}>
                    <a href="#" className={styles.substatus_btn_active}>SOLICITED</a>
                    <a href="#" className={styles.substatus_btn}>UNSOLICITED</a>
                  </div>

                  <h3 className={styles.lead_title}>Pending - Solicited</h3>
                </div>
                ...
                <div className={styles.preview_header}>
                  <div className="d-flex flex-column flex-sm-row justify-content-center justify-content-sm-between align-items-center">
                    ...
                    <div className={styles.pending_box}>
                      <img className={styles.clock_icon} src="/landlord/lead/clock-icon.png" alt="clock" />
                      <div className="ml-3">
                        <p className={styles.pending_title}>Offer Pending</p>
                        <p className={styles.pending_detail}>Expires in 72 hours</p>
                      </div>
                    </div>
                  </div>
